                    ...
                    <div id="our-cheffs" class="owl-carousel">
                        <div class="item">
                            <div class="cheffs_wrap">
                                <img src="{{asset('dist/images/our-cheffs1.jpg')}}" alt="Kitchen Staff">
                                <h3>Stafeny Rose</h3>
                        ...
                        <div class="item">
                            <div class="cheffs_wrap">
                                <img src="{{asset('dist/images/our-cheffs2.jpg')}}" alt="Kitchen Staff">
                        ...
                        <div class="item">
                            <div class="cheffs_wrap">
                                <img src="{{asset('dist/images/our-cheffs3.jpg')}}" alt="Kitchen Staff">
                                <h3>Angle Maria</h3>
